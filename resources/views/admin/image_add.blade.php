        ...
        <div class="card-body">
            <div class="card">
                <div class="body">
                    ...
                    <form id="form_validation" action="{{ route('admin_image_store',['news_id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @foreach($images as $rs)
                            <tr>
                                ...
                                <td><a href="{{route('admin_image_delete', ['id' => $rs->id, 'news_id'=>$data->id])}}" onclick="return confirm('Record will be Delete! Are you sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" height="25"></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
